        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large" src="{{ $product->gallery->first()->getUrl() }}" alt="">
                    </div>
                    @foreach($product->getMedia('gallery') as $gallery)
                    <div class="product__details__pic__slider owl-carousel">
                        <img data-imgbigurl="{{ $gallery->getUrl() }}" src="{{ $gallery->getUrl() }}" alt="">
                    </div>
                    @endforeach
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <ul>
                        <li><b>Availability</b> <span>{{ $product->quantity }} pcs</span></li>
